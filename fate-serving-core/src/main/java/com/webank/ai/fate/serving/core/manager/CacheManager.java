...
//                .expireAfterAccess(Configuration.getPropertyInt(Dict.PROPERTY_REMOTE_MODEL_INFERENCE_RESULT_CACHE_TTL), TimeUnit.SECONDS)
//                .maximumSize(Configuration.getPropertyInt(Dict.PROPERTY_REMOTE_MODEL_INFERENCE_RESULT_CACHE_MAX_SIZE))
//                .build();
//
//        inferenceResultCache = CacheBuilder.newBuilder()
//                .expireAfterAccess(Configuration.getPropertyInt(Dict.PROPERTY_INFERENCE_RESULT_CACHE_TTL), TimeUnit.SECONDS)
//                .maximumSize(Configuration.getPropertyInt(Dict.PROPERTY_INFERENCE_RESULT_CACHE_CACHE_MAX_SIZE))
//                .build();
//
//        JedisPoolConfig jedisPoolConfig = new JedisPoolConfig();
//        jedisPoolConfig.setMaxTotal(Configuration.getPropertyInt(Dict.PROPERTY_REDIS_MAXTOTAL));
//        jedisPoolConfig.setMaxIdle(Configuration.getPropertyInt(Dict.PROPERTY_REDIS_MAXIDLE));
//        jedisPool = new JedisPool(jedisPoolConfig,
//                Configuration.getProperty(Dict.PROPERTY_REDIS_IP),
//                Configuration.getPropertyInt(Dict.PROPERTY_REDIS_PORT),
//                Configuration.getPropertyInt(Dict.PROPERTY_REDIS_TIMEOUT),
//                Configuration.getProperty(Dict.PROPERTY_REDIS_PASSWORD));
//        inferenceResultCacheDBIndex = initializeCacheDBIndex(Configuration.getProperty(Dict.PROPERTY_EXTERNAL_INFERENCE_RESULT_CACHE_DB_INDEX));
//        externalInferenceResultCacheTTL = Configuration.getPropertyInt(Dict.PROPERTY_EXTERNAL_INFERENCE_RESULT_CACHE_TTL);
//        remoteModelInferenceResultCacheDBIndex = initializeCacheDBIndex(Configuration.getProperty(Dict.PROPERTY_EXTERNAL_REMOTE_MODEL_INFERENCE_RESULT_CACHE_DB_INDEX));
//        externalRemoteModelInferenceResultCacheTTL = Configuration.getPropertyInt(Dict.PROPERTY_EXTERNAL_REMOTE_MODEL_INFERENCE_RESULT_CACHE_TTL);
//        canCacheRetcode = initializeCanCacheRetcode();
//    }
//
//    public void store(Context  context,String  key,Map<String,Object>  data){
//
//
//
//
...
//
//
//    private static <T> T getFromRedisCache(String cacheKey, CacheValueConfig cacheValueConfig,Class<T> dataType) {
...
//    }
//
//    private static void putIntoRedisCache(String cacheKey, CacheValueConfig cacheValueConfig, Object returnResult) {
//        try (Jedis jedis = jedisPool.getResource()) {
...
//        String[] retcodeString = Configuration.getProperty(Dict.PROPERTY_CAN_CACHE_RET_CODE).split(",");
